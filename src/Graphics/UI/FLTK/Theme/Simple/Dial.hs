...
module Graphics.UI.FLTK.Theme.Simple.Dial
  (
    dialNew,
    drawDial,
    fillDialNew,
...
strokeWidth = percentOfSize 10
meterCenterRadius = percentOfSize 8
meterWidth = percentOfSize 5
knobPadding = percentOfSize 3
arrowBase = percentOfSize 25
arrowHeight = percentOfSize 20
arrowPadding = percentOfSize 15
