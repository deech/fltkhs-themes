...
module Graphics.UI.FLTK.Theme.Simple.Clock
  (
    clockNew,
    drawClock
  )
...
clockSvg (Width w) (Height h) colorRgb selectionColorRgb (LowLevel.ClockByTime (LowLevel.Hour hours) (LowLevel.Minute minutes) (LowLevel.Second seconds)) =
  let widthRadius :: Double
      ...
      withinSvg innards =
        ...
        ++ innards ++ "</svg>\n"
      strokeWidth = percentOfSize 10 ellipseRadius
      tickPadding = percentOfSize 15 ellipseRadius
      tickHeight = percentOfSize 10 ellipseRadius
      centerRadius = percentOfSize 5 ellipseRadius
      secondHandWidth = percentOfSize 3 ellipseRadius
      minuteHandWidth = percentOfSize 3 ellipseRadius
      minuteHandHeight = percentOfSize 80 ellipseRadius
      hourHandWidth = percentOfSize 3 ellipseRadius
      hourHandHeight = percentOfSize 70 ellipseRadius
